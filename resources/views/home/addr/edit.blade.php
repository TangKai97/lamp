		...
		<div class="m_right">
            <form action="/home/addr/{{$data->id}}" method="post">
              ...
              <div style="position:relative; left:90px">
                <tr>
                  所在城区：<select id="Province" runat="server" name="province" style="width: 90px" ></select>
                         <select id="Country" runat="server" name="country" style="width: 90px"></select>
                         <select id="Town" runat="server" name="town" style="width: 90px"></select><br><br>
                  <td align="right">详细地址&nbsp;&nbsp;：&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><input type="text" value="{{$data->addrinfo}}" class="add_ipt" placeholder="如街道、小区、门牌号等" name="addrinfo" required>（必填）</td><br><br>
                  <td align="right">收货人姓名&nbsp;：&nbsp;</td>
                  <td><input type="text" value="{{$data->aname}}" class="add_ipt" placeholder="姓名" name="aname" required>（必填）</td><br><br>
                  <td align="right">手机号码&nbsp;&nbsp;：&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><input type="text" value="{{$data->atel}}" class="add_ipt" placeholder="电话" name="atel" required>（必填）</td><br><br>
