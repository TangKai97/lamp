    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <div class="des_share">
                ...
                <div class="d_care"><a href="/home/collection/{{$data->gid}}">关注商品</a></div>
            </div>
            <div class="des_join">
                <div class="j_nums">
    ...
    <div class="content mar_20">
        <div class="l_history">
            ...
            <ul>
                @foreach($nfos as $k=>$v)
                <li>
                    <div class="img"><a href="#"><img src="/uploads/{{ $v->ipic }}" width="185" height="162" /></a></div>
                    <div class="name"><a href="#">{{$v->info}}</a></div>
                    <div class="price">
